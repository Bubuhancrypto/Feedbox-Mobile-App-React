    ...
    <div className="navbar-container-navbar-container">
      <header data-role="Header" className="navigation-container">
        ...
        <div className="navbar-container-nav">
          <nav className="navbar-container-nav1">
            <a href="#about" className="navbar-container-link navbar-link">
              {props.text}
            </a>
            <a href="#work" className="navbar-container-link1 navbar-link">
              {props.text1}
            </a>
            <a href="#connect" className="navbar-container-link2 navbar-link">
              {props.text2}
            </a>
          </nav>
        </div>
        ...
        <div data-type="MobileMenu" className="navigation-mobile-menu">
          <div className="navbar-container-nav2">
            <div className="navbar-container-container">
              <img
                alt={props.image_alt1}
                src={props.image_src1}
                className="navbar-container-image1"
              />
              <div
                data-type="CloseMobileMenu"
                className="navbar-container-menu-close"
              >
                <svg
                  viewBox="0 0 1024 1024"
                  className="navbar-container-icon02"
                >
            ...
            <button className="navbar-container-primary-btn button-primary button">
              {props.PrimaryBtn1}
            </button>
          </div>
          <div className="navbar-container-social-media">
            <span className="navbar-container-text">{props.text3}</span>
            <div className="navbar-container-container1">
              <svg viewBox="0 0 1024 1024" className="navbar-container-icon04">
              ...
              <svg viewBox="0 0 1024 1024" className="navbar-container-icon08">
              ...
              <svg viewBox="0 0 1024 1024" className="navbar-container-icon12">
              ...
              <svg viewBox="0 0 1024 1024" className="navbar-container-icon14">
        ...
        <a
          ...
          className="navbar-container-primary-btn1 button-primary button"
        >
          {props.PrimaryBtn}
        </a>
      </header>
